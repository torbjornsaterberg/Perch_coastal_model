...
Godkänd ='JA'
AND 
Lokal_ID IN(129, 49, 31, 65, 79, 84, 82, 66, 106, 94, 54, 28, 57, 203, 48) -- Torhamn, Holmön, Forsmark, Långvindsfjärden, Norrbyn, Kinnbäcksfjärden, Gaviksfjärden, Lagnö, Råneå, Asköfjärden, Kvädöfjärden, Finbo(Åland), Kumlinge(Åland), Askrikefjärden(Vaxholm), Östra Gotland m kustvatten
AND 
...
ggplot(join_age_effort, aes(x=age,y=CPUE_age,group=age)) + geom_boxplot() + facet_wrap(vars(Lokal),scales="free_y")# + ylim(0,100)
```
