...
$$
\bar{Z}_t = \frac{\sum_{a} Z_{a,t} \cdot N_{a,t}}{\sum_{a} N_{a,t}}
$$
...
$$
\bar{Z}_a = \frac{\sum_{t=1}^{T} Z_{a,t}}{T}
$$
...
Godkänd ='JA'
AND 
Lokal_ID IN(129, 49, 31, 65, 79, 84, 82, 66, 106, 94, 54, 28, 57, 203, 48) -- Torhamn, Holmön, Forsmark, Långvindsfjärden, Norrbyn, Kinnbäcksfjärden, Gaviksfjärden, Lagnö, Råneå, Asköfjärden, Kvädöfjärden, Finbo(Åland), Kumlinge(Åland), Askrikefjärden(Vaxholm), Östra Gotlands m kustvatten
AND 
...
Störning='NEJ'
AND 
Lokal_ID IN(129, 49, 31, 65, 79, 84, 82, 66, 106, 94, 28, 57, 203, 48) -- Torhamn, Holmön, Forsmark, Långvindsfjärden, Norrbyn, Kinnbäcksfjärden, Gaviksfjärden, Lagnö, Råneå, Asköfjärden, Finbo(Åland), Kumlinge(Åland), Askrikefjärden(Vaxholm), Östra Gotlands m kustvatten
AND 
Fiske IN ('Nordiska nät augusti','Kontrollprogram Nordiska nät augusti')
AND 
Fångstområde <> 'Långvindsfjärden reservat'
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Råneå for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Råneå.RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Råneå.RDS")
...
# Load MCMC data #
##################
file_path <- list.files(path="../MCMCOutput",
                    pattern = "^fit_Råneå",
                    full.names = TRUE)
...
# Plot relative age-class abundance over time
visualize_relative_age_class_abundance(fit_summary, plottitle) 
...
# Save relative age-class abundance
rel_N_Råneå <- extract_relative_age_class_abundance(fit_summary, plottitle)
...
assign("Z_hat_Råneå", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Råneå <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save age-class specific annyal mortality estimate 
Z_Råneå <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Råneå <- extract_recruitment_estimates(fit_summary, plottitle)
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Kinnbäcksfjärden" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Kinnbäcksfjärden", Sys.Date(),".RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Kinnbäcksfjärden.RDS")
```
...
# Save relative age-class abundance
rel_N_Kinnbäcksfjärden <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Kinnbäcksfjärden", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Kinnbäcksfjärden <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Kinnbäcksfjärden <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Kinnbäcksfjärden <- extract_recruitment_estimates(fit_summary, plottitle)
```
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Holmön" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Holmön", Sys.Date(),".RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Holmön.RDS")
```
...
# Save relative age-class abundance
rel_N_Holmön <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Holmön", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Holmön <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Holmön <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Holmön <- extract_recruitment_estimates(fit_summary, plottitle)
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Norrbyn" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Norrbyn", Sys.Date(),".RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Norrbyn.RDS")
```
...
# Save relative age-class abundance
rel_N_Norrbyn <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Norrbyn", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Norrbyn <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Norrbyn <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Norrbyn <- extract_recruitment_estimates(fit_summary, plottitle)
```
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Gaviksfjärden" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Gaviksfjärden", Sys.Date(),".RDS"))


# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Gaviksfjärden.RDS")
```
...
# Save relative age-class abundance
rel_N_Gaviksfjärden <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Mean age-class mortality
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Gaviksfjärden", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Gaviksfjärden <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Gaviksfjärden <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Gaviksfjärden <- extract_recruitment_estimates(fit_summary, plottitle)
```
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Långvindsfjärden" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Långvindsfjärden", Sys.Date(),".RDS"))


# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Långvindsfjärden.RDS")
```
...
# Save relative age-class abundance
rel_N_Långvindsfjärden <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Långvindsfjärden", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Långvindsfjärden <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Långvindsfjärden <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Långvindsfjärden <- extract_recruitment_estimates(fit_summary, plottitle)
```
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Forsmark" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Forsmark", Sys.Date(),".RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Forsmark.RDS")
```
...
# Save relative age-class abundance
rel_N_Forsmark <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Forsmark", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Forsmark <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Forsmark <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Forsmark <- extract_recruitment_estimates(fit_summary, plottitle)
```
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Finbo, Åland" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Finbo", Sys.Date(),".RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Finbo.RDS")
```
...
The model has converged and there is only one divergent transitions. The model underestimates the proportion of zeros in data for age-group 1 and seems to overestimate the age-group 1 abundance to some extent. There might also be a slight underestimation age-class 2 abundance.
...
# Save relative age-class abundance
rel_N_Finbo <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Finbo", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Finbo <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Finbo <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Finbo <- extract_recruitment_estimates(fit_summary, plottitle)
```
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Kumlinge, Åland" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Kumlinge", Sys.Date(),".RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Kumlinge.RDS")
```
...
# Save relative age-class abundance
rel_N_Kumlinge <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign(paste0("Z_hat_Kumlinge"), ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Kumlinge <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save age-class specific annyual mortality estimate 
Z_Kumlinge <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Kumlinge <- extract_recruitment_estimates(fit_summary, plottitle)
```
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Lagnö" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Lagnö", Sys.Date(),".RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Lagnö.RDS")
```
...
# Save relative age-class abundance
rel_N_Lagnö <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Lagnö", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Lagnö <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Lagnö <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Lagnö <- extract_recruitment_estimates(fit_summary, plottitle)
```
...
## 5.11 Askrikefjärden (Vaxholm)

See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Vaxholm (Askrikefjärden)" for a detailed description of the data collection
...
# Add title for plots for this area
plottitle = "Askrikefjärden (Vaxholm)"
```
...
fit$save_object(paste0("../MCMCOutput/fit_Askrikefjärden", Sys.Date(),".RDS"))


# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Askrikefjärden.RDS")
```
...
# Save relative age-class abundance
rel_N_Askrikefjärden <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Askrikefjärden", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Askrikefjärden <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Askrikefjärden <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Askrikefjärden <- extract_recruitment_estimates(fit_summary, plottitle)
```
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Asköfjärden" for a detailed description of the data collection
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Asköfjärden", Sys.Date(),".RDS"))


# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Asköfjärden.RDS")
```
...
##################
file_path <- list.files(path="../MCMCOutput",
                    pattern = "^fit_Asköfjärden",
                    full.names = TRUE)

fit <- readRDS(file_path)
```

### 5.12.3 Model diagnostics
...
# Save relative age-class abundance
rel_N_Asköfjärden <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Asköfjärden", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Asköfjärden <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Asköfjärden <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Asköfjärden <- extract_recruitment_estimates(fit_summary, plottitle)
```

### 5.12.6 Retrospective analysis and prediction accuracy
...
See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Kvädöfjärden" for a detailed description of the data collection\
Note tha K053 (Nätlänkar) instead of K064 (nordiska nät) have been used to collect age-data here!
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Kvädöfjärden", Sys.Date(),".RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Kvädöfjärden.RDS")
```
...
##################
file_path <- list.files(path="../MCMCOutput",
                    pattern = "^fit_Kvädöfjärden",
                    full.names = TRUE)

fit <- readRDS(file_path)
```

### 5.13.3 Model diagnostics
...
# Save relative age-class abundance
rel_N_Kvädöfjärden <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Kvädöfjärden", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Kvädöfjärden <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Kvädöfjärden <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Kvädöfjärden <- extract_recruitment_estimates(fit_summary, plottitle)
```

### 5.13.6 Retrospective analysis and prediction accuracy
...
## 5.14 Östra Gotlands m kustvatten
...
data_wide <- summarize_plusgroup(min_age = 1,
                    plus_age = 2,
                    area = "Östra Gotlands m kustvatten",
                    data = join_age_per_obsid_effort)
...
# Add title for plots for this area
plottitle = "Östra Gotlands m kustvatten"
```
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Östra_Gotlands_m_kustvatten.RDS"))

# save input data
saveRDS(STAN_input,
        "../MCMCOutput/inputdata_Östra_Gotlands_m_kustvatten.RDS")
...
##################
file_path <- list.files(path="../MCMCOutput",
                    pattern = "^fit_Östra_Gotlands",
                    full.names = TRUE)

fit <- readRDS(file_path)
```

### 5.14.3 Model diagnostics
...
#### 5.14.4.1 Comment on model fit

Fit seems to be ok. The model has converged(only 1 divergent transition out of 4000 iteration). Further, posterior predictive checks indicate that the model is predicting in-sample data reasonably, except for the age-class 4 where the model tend to overestimate the number of zeros in the data.

### 5.14.5 Stock indicators
...
# Save relative age-class abundance
rel_N_Östra_Gotlands_m_kustvatten <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Östra_Gotlands_m_kustvatten", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Östra_Gotlands_m_kustvatten <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save age-class specific annyal mortality estimate
Z_Östra_Gotlands_m_kustvatten <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Östra_Gotlands_m_kustvatten <- extract_recruitment_estimates(fit_summary, plottitle)

```

### 5.14.6 Retrospective analysis and prediction accuracy
...
-   Time series showing number of individuals caught per age-class and year indicate that model gives a relatively good fit to data, with no clear observations of biased estimates.
-   Mortality is high in this area, with no clear observations of any time trend.
-   The recruitment index indicates that the warm summer 2018 was associated with good recruitment.


## 5.15 Torhamn

See handboksblad at "//storage-og.slu.se/restricted\$/Provfiske/Handboksblad/Torhamn" for a detailed description of the data collection.
...
# save MCMC data
fit$save_object(paste0("../MCMCOutput/fit_Torhamn", Sys.Date(),".RDS"))

# save input data
saveRDS(STAN_input, 
        "../MCMCOutput/inputdata_Torhamn.RDS")
```
...
# Save relative age-class abundance
rel_N_Torhamn <- extract_relative_age_class_abundance(fit_summary, plottitle)

# Make table with mean age-class mortalities
ft <- make_mean_age_class_mortality_table(fit_summary,plottitle)
print(ft) # render in qmd
assign("Z_hat_Torhamn", ft$body$dataset) # store mean age-class mortalities for later plotting

# Save annual mortality estimates
Z_mean_Torhamn <- extract_annual_mortality_estimates(fit_summary, plottitle)

# Save mortality estimate 
Z_Torhamn <- extract_mortality_estimates(fit_summary, plottitle)

# Save recruitment estimate
R_Torhamn <- extract_recruitment_estimates(fit_summary, plottitle)
```

### 5.15.6 Retrospective analysis and prediction accuracy
...
## 5.16 Save mortality and recruitment estimates for all areas

```{r}

# extract GIS coordinates to areas
GIS_coord <- unique(cbind(Kul_data$Lokal, Kul_data$Lat_grader_lokal, Kul_data$Long_grader_lokal))
colnames(GIS_coord) <- c("Area","Lat_degrees","Long_degrees")
GIS_coord <- as_tibble(GIS_coord)

GIS_coord <- GIS_coord %>%
             mutate(Area = case_match(Area, 
                    "Torhamn, Karlskrona Ö skärgård" ~ "Torhamn",
                    "Finbo, Åland" ~ "Finbo(Åland)",
                    "Kumlinge, Åland" ~ "Kumlinge(Åland)",
                    "Askrikefjärden" ~ "Askrikefjärden (Vaxholm)",
                    .default=Area
                    ))

# Timevarying age-distribution
rel_N_all_areas <- bind_rows(rel_N_Råneå,
                         rel_N_Kinnbäcksfjärden,
                         rel_N_Holmön,
                         rel_N_Norrbyn,
                         rel_N_Gaviksfjärden,
                         rel_N_Långvindsfjärden,
                         rel_N_Forsmark,
                         rel_N_Finbo,
                         rel_N_Kumlinge,
                         rel_N_Lagnö,
                         rel_N_Askrikefjärden,
                         rel_N_Asköfjärden,
                         rel_N_Kvädöfjärden,
                         rel_N_Östra_Gotlands_m_kustvatten,
                         rel_N_Torhamn) %>%
                right_join(GIS_coord, by = join_by(Area)) # append GIS coordinates to mortality estimates

# Time varying mortality for all areas
Z_all_areas <- bind_rows(Z_Råneå,
                         ...
                         Z_Asköfjärden,
                         Z_Kvädöfjärden,
                         Z_Östra_Gotlands_m_kustvatten,
                         Z_Torhamn) %>%
                right_join(GIS_coord, by = join_by(Area)) # append GIS coordinates to mortality estimates

# Mean mean annual mortality per area
Z_mean_all_areas <- bind_rows(Z_mean_Råneå,
                         Z_mean_Kinnbäcksfjärden,
                         Z_mean_Holmön,
                         Z_mean_Norrbyn,
                         Z_mean_Gaviksfjärden,
                         Z_mean_Långvindsfjärden,
                         Z_mean_Forsmark,
                         Z_mean_Finbo,
                         Z_mean_Kumlinge,
                         Z_mean_Lagnö,
                         Z_mean_Askrikefjärden,
                         Z_mean_Asköfjärden,
                         Z_mean_Kvädöfjärden,
                         Z_mean_Östra_Gotlands_m_kustvatten,
                         Z_mean_Torhamn) %>%
                right_join(GIS_coord, by = join_by(Area)) # append GIS coordinates to mortality estimates

# Mean mortality per area, and mean age-class specific mortality per area
Z_hat_all_areas <- bind_rows(Z_hat_Råneå,
                         Z_hat_Kinnbäcksfjärden,
                         Z_hat_Holmön,
                         Z_hat_Norrbyn,
                         Z_hat_Gaviksfjärden,
                         Z_hat_Långvindsfjärden,
                         Z_hat_Forsmark,
                         Z_hat_Finbo,
                         Z_hat_Kumlinge,
                         Z_hat_Lagnö,
                         Z_hat_Askrikefjärden,
                         Z_hat_Asköfjärden,
                         Z_hat_Kvädöfjärden,
                         Z_hat_Östra_Gotlands_m_kustvatten,
                         Z_hat_Torhamn) %>%
                right_join(GIS_coord, by = join_by(Area)) # append GIS coordinates to mortality estimates

# Recruitment indices for all areas
R_all_areas <- bind_rows(R_Råneå,
                         R_Kinnbäcksfjärden,
                         R_Holmön,
                         R_Norrbyn,
                         R_Gaviksfjärden,
                         ...
                         R_Asköfjärden,
                         R_Kvädöfjärden,
                         R_Östra_Gotlands_m_kustvatten,
                         R_Torhamn) %>%
                right_join(GIS_coord, by = join_by(Area)) # append GIS coordinates to recruitment estimates


############################################
# Save mortality and recruitment estimates #
############################################

# save table with time varying age-distribution for all areas
write_csv(rel_N_all_areas, "Perch_figures/rel_N_all_areas.csv") 

# save table with time varying mortalities for all areas
write_csv(Z_all_areas, "Perch_figures/Z_all_areas.csv") 

# save table with mean annual mortality for all areas
write_csv(Z_mean_all_areas, "Perch_figures/Z_mean_all_areas.csv") 

# save table with mean annual mortality for all areas
write_csv(Z_hat_all_areas, "Perch_figures/Z_hat_all_areas.csv") 

# save table with recruitment index for all areas
write_csv(R_all_areas, "Perch_figures/R_all_areas.csv") 
```
